...
const Navigation = () => {
  ...
  return (
<nav className='flex justify-between px-10 py-5 items-center text-white'>
    <div>
        <h2 className='text-[30px]  font-bold'>EV-olution</h2>
    </div>
    ...
    <ul className={`res-69:gap-[20px] res-70:flex  transition duration-500 ${menu ? 'showMenu' : 'hidden'}`}>
        <li className='mx-9 my-10'><a href="#" className='text-[17px] bg-white px-2 text-black font-semibold py-1 rounded-sm fixed right-2 res-70:hidden block' onClick={()=> setMenu(false)}>X</a></li>
